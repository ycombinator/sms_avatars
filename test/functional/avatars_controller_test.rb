...
class AvatarsControllerTest < ActionController::TestCase
  ...
  test "should create avatar" do
    assert_difference('Avatar.count') do
      post :create, avatar: { name: @avatar.name, number: @avatar.number, test_number_id: @avatar.test_number_id }
    end
  ...
  test "should update avatar" do
    put :update, id: @avatar, avatar: { name: @avatar.name, number: @avatar.number, test_number_id: @avatar.test_number_id }
    assert_redirected_to avatar_path(assigns(:avatar))
  end
